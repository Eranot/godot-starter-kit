...
# This function makes custom constants modifications easier
	match side:
		LEFT:
			set("theme_override_constants/margin_left", value)
		RIGHT:
			set("theme_override_constants/margin_right", value)
		TOP:
			set("theme_override_constants/margin_top", value)
		BOTTOM:
			set("theme_override_constants/margin_bottom", value)
